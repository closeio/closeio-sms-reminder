...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { appointment: @reminder.appointment, message: @reminder.message, name: @reminder.name, phonenumber: @reminder.phonenumber }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { appointment: @reminder.appointment, message: @reminder.message, name: @reminder.name, phonenumber: @reminder.phonenumber }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
